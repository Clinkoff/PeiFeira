...
namespace PeiFeira.Infrastructure.Migrations
{
    ...
    [Migration("20251012174223_Fase4_AjustarConviteEquipe")]
    partial class Fase4_AjustarConviteEquipe
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PeiFeira.Domain.Entities.Projetos.Projeto", b =>
                {
                    ...
                    b.HasOne("PeiFeira.Domain.Entities.Semestres.Semestre", null)
                        .WithMany("Projetos")
                        .HasForeignKey("SemestreId");

                    b.HasOne("PeiFeira.Domain.Entities.Turmas.Turma", null)
                        .WithMany("Projetos")
                        .HasForeignKey("TurmaId");
