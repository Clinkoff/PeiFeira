...
namespace PeiFeira.Infrastructure.Migrations
{
    ...
    [Migration("20251012173151_Fase1_CriarDisciplinaPI")]
    partial class Fase1_CriarDisciplinaPI
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PeiFeira.Domain.Entities.DisciplinaPI.DisciplinaPI", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PeiFeira.Domain.Entities.DisciplinaPI.DisciplinaPITurma", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PeiFeira.Domain.Entities.Equipes.ConviteEquipe", b =>
                {
                    ...
                    b.HasIndex("ConvidadoPorId");

                    b.HasIndex("Status");

                    b.HasIndex("EquipeId", "ConvidadoId")
                        .IsUnique()
            ...
            modelBuilder.Entity("PeiFeira.Domain.Entities.Projetos.Projeto", b =>
                {
                    ...
                    b.Property<int?>("DisciplinaPIId")
                        .HasColumnType("int");

                    b.Property<Guid?>("DisciplinaPIId1")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ProfessorOrientadorId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DisciplinaPIId1");

                    b.HasIndex("IsActive");

                    b.HasIndex("ProfessorOrientadorId");
            ...
            modelBuilder.Entity("PeiFeira.Domain.Entities.Avaliacoes.Avaliacao", b =>
                {
                    ...
                    b.HasOne("PeiFeira.Domain.Entities.Projetos.Projeto", null)
                        .WithMany("Avaliacoes")
            ...
            modelBuilder.Entity("PeiFeira.Domain.Entities.DisciplinaPI.DisciplinaPITurma", b =>
                {
                    b.HasOne("PeiFeira.Domain.Entities.DisciplinaPI.DisciplinaPI", "DisciplinaPI")
            ...
            modelBuilder.Entity("PeiFeira.Domain.Entities.Equipes.ConviteEquipe", b =>
                {
                    b.HasOne("PeiFeira.Domain.Entities.Usuarios.Usuario", "Convidado")
                        .WithMany()
                        .HasForeignKey("ConvidadoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PeiFeira.Domain.Entities.Usuarios.Usuario", "ConvidadoPor")
                        .WithMany()
                        .HasForeignKey("ConvidadoPorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("PeiFeira.Domain.Entities.Projetos.Projeto", b =>
                {
                    b.HasOne("PeiFeira.Domain.Entities.DisciplinaPI.DisciplinaPI", null)
                        .WithMany("Projetos")
                        .HasForeignKey("DisciplinaPIId1");

                    b.HasOne("PeiFeira.Domain.Entities.Usuarios.PerfilProfessor", "ProfessorOrientador")
                        .WithMany("ProjetosOrientados")
                        .HasForeignKey("ProfessorOrientadorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ProfessorOrientador");
            ...
            modelBuilder.Entity("PeiFeira.Domain.Entities.Usuarios.PerfilProfessor", b =>
                {
                    b.Navigation("ProjetosOrientados");
                });
