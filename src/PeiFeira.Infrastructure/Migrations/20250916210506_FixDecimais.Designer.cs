...
namespace PeiFeira.Infrastructure.Migrations
{
    ...
    [Migration("20250916210506_FixDecimais")]
    partial class FixDecimais
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PeiFeira.Domain.Entities.Usuarios.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9088e821-3661-43be-a874-57d24304beda"),
                            CriadoEm = new DateTime(2025, 9, 16, 21, 5, 6, 313, DateTimeKind.Utc).AddTicks(1408),
