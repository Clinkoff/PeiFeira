...
public class CreateProjetoRequestValidator : BaseValidator<CreateProjetoRequest>
{
    public CreateProjetoRequestValidator()
    {
        RuleFor(p => p.DisciplinaPIId)
            .NotEmpty().WithMessage("DisciplinaPIId é obrigatório")
            .Must(BeValidGuid).WithMessage("DisciplinaPIId inválido");
